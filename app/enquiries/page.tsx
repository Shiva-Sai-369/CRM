      ...
      <div className="w-full mb-6">
        <div className="mb-4 bg-white border border-gray-200 rounded-lg shadow-sm p-4">
          <div className="flex flex-wrap items-center gap-3">
            ...
            {selectedProjectId && selectedProjectId !== "all" && sheets.length === 0 && (() => {
              const project = projects.find(p => p.id === selectedProjectId);
              return project && (project as any)._localStorage ? (
                <div className="text-xs text-amber-600 bg-amber-50 px-3 py-2 rounded border border-amber-200 flex items-start gap-2">
                  ...
                  <span>
                    <strong>"{project.name}"</strong> is a localStorage project. No Google Sheets synced yet.
                    Go to Settings → assign a sheet → click "🔄 Sync to Supabase" to load leads here.
                  </span>
                </div>
              ) : null;
            })()}
